...
set(COLA2_LIB_INCLUDE_DIRS "${COLA2_LIB_CMAKE_DIR}/../../include/cola2_lib;/usr/include;/usr/include/eigen3")
set(COLA2_LIB_LIBRARY_DIRS "${COLA2_LIB_CMAKE_DIR}/../../lib")
set(COLA2_LIB_EXECUTABLE_DIRS "${COLA2_LIB_CMAKE_DIR}/../../bin")
list(APPEND CMAKE_MODULE_PATH "${COLA2_LIB_CMAKE_DIR}")
